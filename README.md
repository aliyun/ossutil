...
## About
- This tool is developed with Go and built on the official GO SDK v2.0.0 alpha of OSS [Alibaba Cloud Object Storage Service](http://www.aliyun.com/product/oss/).
